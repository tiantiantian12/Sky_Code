...
CUSTOM_MODELS_FILE = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "config", "custom_models.json")
...
class CustomModelService:
    ...
    def _load(self):
        ...
        if os.path.exists(CUSTOM_MODELS_FILE):
            try:
                with open(CUSTOM_MODELS_FILE, 'r', encoding='utf-8-sig') as f:
